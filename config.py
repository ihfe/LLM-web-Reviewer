...
API_KEY = "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"    # 可同时填写多个API-KEY，用英文逗号分割，例如API_KEY = "sk-openaikey1,sk-openaikey2,fkxxxx-api2dkey3,azure-apikey4"
...
if USE_PROXY:
    ...
    proxies = {
        #          [协议]://  [地址]  :[端口]
        "http": "http://127.0.0.1:7890", # 再例如  "https": "http://127.0.0.1:7890",
...
# 多线程函数插件中，默认            from check_proxy import check_proxyhigh允许多少路线程同时访问OpenAI。Free trial users的限制是每分钟3次，Pay-as-you-go users的限制是每分钟3500次
...
THEME = "Default"
AVAIL_THEMES = ["Default","High-Contrast", "Gstaff/Xkcd", "NoCrypt/Miku","ParityError/Anime","gradio/seafoam"]
